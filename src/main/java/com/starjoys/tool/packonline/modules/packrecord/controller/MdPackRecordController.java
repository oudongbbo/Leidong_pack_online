...
import com.starjoys.tool.packonline.modules.packrecord.service.MdPackRecordService;
...
@Controller
@RequestMapping("/packRecord/mdPackRecord")
public class MdPackRecordController extends BaseManagerController<MdRecordEntity> {

    @Resource
    private MdPackRecordService mdPackRecordService;
    ...
    @Override
    protected IBaseManagerService<MdRecordEntity> getBaseManagerService() {
        return mdPackRecordService;
    }
    ...
    public String show(HttpServletRequest request, Model model) {
        ...
        return WebPathConfig.JSP_PATH_PACK_RECORD_MD;
    }

    @Override
    public ResultBean<List<MdRecordEntity>> list(HttpServletRequest request, MdRecordEntity entity) {
        // 默认只给用户看到该公司的打包记录
