...
@Controller
@RequestMapping("/sdk/sdkVersionManager")
public class SdkVersionManagerController extends BaseManagerController<SdkEntity> {
    ...
    public String show(HttpServletRequest request, Model model) {
        sendLog("接受到显示页面的请求");
        return WebPathConfig.JSP_PATH_SDK_VERSION_MANAGER;
    }
