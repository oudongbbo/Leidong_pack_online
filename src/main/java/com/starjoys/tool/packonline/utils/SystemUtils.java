...
//		System.out.println("Current OS is "+osName);
    ...
    public static final int IS_UNKNOWN_OS = 0;
...
//		System.out.println("Current OS is "+osName);
        ...
        if (osName == null) {
            System.out.println("无法获取系统信息");
            return IS_UNKNOWN_OS;
        } else {
     ...
     */
    //其它的一些东西,会有用到的时候的
    public static void getAllSystemProperties(){
