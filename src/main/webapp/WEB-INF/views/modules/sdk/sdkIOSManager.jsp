...
<script type="text/javascript">
    ...
    function edit() {
        $('#wu-form-2').form('submit', {
            url: '${ctx}/sdk/sdkIOSManager/edit',
            success: function (data) {
                // 隐藏
                disLoad();
...
//            $.messager.alert("信息提示", "请先选择修改的数据项", "info");
    ...
    function change() {
        $('#wu-form-3').form('submit', {
            url: '${ctx}/sdk/sdkIOSManager/change',
            success: function (data) {
                // 隐藏
                disLoad();
    ...
    function loadData(query_params) {
        ...
        $('#wu-datagrid-2').datagrid({
            idField: 'sdkId',
            url: '${ctx}/sdk/sdkIOSManager/list',
            ...
            columns: [[
                ...
                {field:'operation2', title: '操作2', width: 80, formatter: function (val, row) {
                    return '<a class="wu-table-operation"  href="sdkVersionIOSManager?sdkId=' + row.sdkId + '">查询详情</a>';
                }},
