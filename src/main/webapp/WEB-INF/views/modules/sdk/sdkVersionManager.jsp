...
<div id="wu-layout" class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar-2">
        <div class="wu-toolbar-button">
            <a href="${ctx}/sdk/sdkManager" class="easyui-linkbutton" iconCls="icon-back" plain="false">返回国内SDK</a>
...
<script type="text/javascript">
    ...
    function edit() {
        $('#wu-form-1').form('submit', {
            url: '${ctx}/sdk/sdkVersionManager/edit',
...
//            $.messager.alert("信息提示", "请先选择修改的数据项", "info");
    ...
    function loadData() {
        ...
        $('#wu-datagrid-2').datagrid({
            ...
            url: '${ctx}/sdk/sdkVersionManager/list?sdkId=' + params["sdkId"],
